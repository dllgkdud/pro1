...
<%
	...
	try {
		...
		sql = "select a.no no, a.title title, a.content content b.name name, a.author author, a.regdate regdate from board1 a inner join member1 b on a.author=b.id where a.no=?";
