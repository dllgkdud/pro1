...
<style>
.hd { width: 100%; height: 50px; position: absolute; top: 0; left: 0; z-index: 99; }
...
.page_tit { padding-top: 1em; text-align: center; }
.agree { width: 1000px; white-space: pre-wrap; margin: 10px auto; padding: 10px; border: 1px solid #ddd; height: 300px; overflow-y: auto; }
.btn { width: 1000px; padding: 30px 90px; }
.btn1 { display: block; width: 400px; height: 50px; border: 1px solid #186ea3; background-color: #3387bd; cursor:pointer; line-height: 10px; 
font-weight: 600; text-decoration: underline; float: left; color: #fff; margin: 10px 300px; }
.btn1:hover { background-color: #186ea3; }
...
<body>
    <div class="wrap">
        ...
        <div class="content">
            <figure class="vs">
                <img src="./img/bg4_visual.png" alt="">
            </figure>
            <div class="bread">
                <div class="bread_fr">
            ...
            <section class="page">
                <div class="page_wrap">
                    <h3 class="page_tit">이용 약관 동의</h3>
                    <h5 class="page_tit">보안성과 편의성이 강화된 현대자동차 통합계정 약관에 동의해주세요.</h5>
                    <div class="agree">
제1장 총칙
...
제33조(분쟁의 해결) "회사"는 분쟁이 발생하였을 경우에 "이용자"가 제기하는 정당한 의견이나 불만을 반영하여 적절하고 신속한 조치를 취합니다. 다만, 신속한 처리가 곤란한 경우에 "회사"는 "이용자"에게 그 사유와 처리일정을 통보합니다. 
                    ...
                    <div class="btn">
                        <input type="checkbox" id="ck1" name="ck1"> <label for="ck1">전체 약관에 동의합니다.</label><br><br>
                        <button type="button" id="btn1" class="btn1">동의</button>
                    </div>
                    <script>
