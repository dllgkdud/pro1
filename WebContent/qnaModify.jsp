	                		...
	                		<form name="frm" action="qnaModifyPro.jsp" method="post" class="frm">
		                		<table class="brd_wrap">
		                			<tbody class="brd_tbody">
		                				...
		                				<tr>
		                					<th><label for="ps">비밀글</label></th>
		                					<td>
		                						<span>
		                							<input type="radio" name="ps"  id="ps1" value="Y"><label for="">비밀</label>
		                							<input type="radio" name="ps"  id="ps2" value="N" checked><label for="">공개</label>
		                						</span>
		                					</td>
		                				</tr>
		                				<tr>
		                				...
		                				<tr>
		                					...
		                					<td><textarea cols="100" rows="6" name="content"  maxlength="600"><%=rs.getString("content") %></textarea></td>
		                				</tr>
		                				<tr>
		                					<th><label for="author">작성자</label></th>
		                					<td>
		                						<input type="text" name="author" value='<%=rs.getString("author") %>' readonly>
		                						<input type="hidden" name="lev" value="0">
		                					</td>
		                				</tr>
		                				<tr>
		                					<th><label for="sysdate">작성일</label></th>
